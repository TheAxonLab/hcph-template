...
path_to_data="/Users/acionca/data/hcph-template/multivar-v00/derivatives/allInRef-noskull"
cd $path_to_data
...
bash $path_to_script/antsMultivariateTemplateConstruction2-mod.sh -d 3 -b 1 -i 3 -k 2 -f 6x4x2x1 -s 4x2x1x0vox -q 100x100x70x20 -t Affine -m MI -c 0 -n 0 \
	-o A_tpl_ -z $first_t1 -z $first_t2 -y 0 -r 1 templateInput-HPC.csv
